...
//     storageReference.getDownloadURL().then((fileURL) {
//       setState(() {
//         // _uploadedFileURL.add(fileURL.toString());
//         _uploadedFileURL=fileURL;
//         print(_uploadedFileURL);
//         print("????????????????????!!!!!!!!!!@@@@@@@@@@@@@@@@@@@@@@@@@//////////////");
//         // widget.onimageselects(_uploadedFileURL);
//       });
//     });
//   }
...
//     //var image =
//     // ignore: deprecated_member_use
//    ImagePicker.pickImage(source: ImageSource.gallery).then((_img) {
// // setState(() {
//       // _image = _img;
//       // image.add(img);
//       // widget.onimageselects(_image);
